...
import QAParser from '../src/qaparser.js';
import {
  sanitizeString,
  sanitizeObject,
  sanitizeObjects,
...
describe('Sanitizer', () => {
  ...
  it('remove greatings', () => {
    const t1 =
      "Bonjour, merci de préciser la matière pour que je puisse vous répondre de manière satisfaisante.\n- Julien, de l'équipe accompagnement";
    const s1 =
      'merci de préciser la matière pour que je puisse vous répondre de manière satisfaisante.';
    const t2 =
      "je vous informe que les choix portés sur la fiche dialogue peuvent être modifiés avec accord des professeurs principaux\n- Florent, de l'équipe accompagnement";
    const s2 =
      'je vous informe que les choix portés sur la fiche dialogue peuvent être modifiés avec accord des professeurs principaux';
