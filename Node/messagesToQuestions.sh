#!/usr/bin/env sh
#CNED
yarn node msgToQA.js --db=bob --user=postgres --host=db-core.czcdgzwouwz1.eu-west-3.rds.amazonaws.com --password 'w36#wdcE12?' --corpus_id=140 --course_id=19 --lang=fr  --quality=unknown --relevancy=1  --visibility --chapter_id=70 --tag_id=8
yarn node msgToQA.js --db=bob --user=postgres --host=db-core.czcdgzwouwz1.eu-west-3.rds.amazonaws.com --password 'w36#wdcE12?' --corpus_id=141 --course_id=18 --lang=fr  --quality=unknown --relevancy=1  --visibility --chapter_id=69 --tag_id=8
yarn node msgToQA.js --db=bob --user=postgres --host=db-core.czcdgzwouwz1.eu-west-3.rds.amazonaws.com --password 'w36#wdcE12?' --corpus_id=142 --course_id=21 --lang=fr  --quality=unknown --relevancy=1  --visibility --chapter_id=72 --tag_id=8
#ASU
yarn node msgToQA.js --db=bob --user=postgres --host=db-core.czcdgzwouwz1.eu-west-3.rds.amazonaws.com --password 'w36#wdcE12?' --corpus_id=146 --course_id=12 --lang=en  --quality=unknown --relevancy=1  --visibility --chapter_id=61 --tag_id=8
